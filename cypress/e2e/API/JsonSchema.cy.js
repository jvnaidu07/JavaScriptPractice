...
// npm install ajv - use this to install ajv
...
describe("validate json schema", ()=>{
    it("validate all response", ()=>{
        ...
        cy.intercept("GET", "https://pagead2.googlesyndication.com/getconfig/sodar?sv=200&tid=gda&tv=r20231207&st=env").as('rahul')
